...
public class Project8 {
    public static void main(String args[]) {
        ...
        File file = new File("csh.ser");
        if(file.exists()==true){
            try {
                ObjectInputStream obj = new ObjectInputStream(new FileInputStream("csh.ser"));
                pbm.setPhoneInfo(obj.readObject());
            } catch (IOException e) {
                e.printStackTrace();
...
class PhoneBookManager{
    ...
    public void setPhoneInfo(Object readObject){
        phoneInfo= (Set<PhoneInfo>) readObject;
    }
    ...
    public void controlData(int num) throws MenuChoiceException {
        ...
        }else if(num==ChoiceMenu.programEnd){
            try {
                ObjectOutputStream obj = new ObjectOutputStream(new FileOutputStream("csh.ser"));
                obj.writeObject(phoneInfo);
                obj.close();
            } catch (IOException e) {
                e.printStackTrace();
            }
